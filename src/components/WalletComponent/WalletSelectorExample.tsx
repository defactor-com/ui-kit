    ...
    <WalletSelector
      ...
      userContext={{
        ...
        networkConnected: {
          ...
          name: "Amoy",
          poolContractAddress: "0x5139129588Ed02d8761aACad1dcCd887c8522f4d",
          rpcUrl: "https://polygon-amoy.g.alchemy.com/v2/QCWsQCDP5n6DN_nyUtWgOhrV3WDq2HC7",
        },
      ...
      onClickMenuOption={(chainId: ChainIdType) => {
        console.error("Function not implemented.");
        return {} as NetworksDataType;
      }}
      onClick={(collateral: TokenBalance) => {
        console.error("Function not implemented.");
      }}
      handleLogout={async () => {
        console.error("Function not implemented.");
